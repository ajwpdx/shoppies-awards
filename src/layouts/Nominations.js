...
const Nominations = (props) => {
    ...
    return(
        <section id="nominations">
            ...
            {props.nominations.map(movie => <MovieNominated key={movie.imdbID} movie={movie} setNominations={props.setNominations} nominations ={props.nominations} enableBtnContext={props.enableBtnContext}/>)}
            </div>
        </section>
    )
}
